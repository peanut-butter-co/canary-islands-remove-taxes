...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const [cardId, setCardId] = (0, import_react15.useState)((documentMetafieldField == null ? void 0 : documentMetafieldField.value) ? documentMetafieldField.value : "");
    const [error, setError] = (0, import_react15.useState)("");
    const applyMetafieldsChange = useApplyMetafieldsChange();
    const setAttribute = useApplyAttributeChange();
    const addressTaxExempt = (countryCode2, provinceCode2) => {
      if (countrySettings[countryCode2] && (countrySettings[countryCode2].taxExemption == "yes" || countrySettings[countryCode2].taxExemption == "per_province" && countrySettings[countryCode2].taxExemptionProvinces.includes(provinceCode2))) {
        return true;
      }
      return false;
    };
    const documentRequired = (countryCode2, provinceCode2) => {
      if (countrySettings[countryCode2] && (countrySettings[countryCode2].documentRequired == "yes" || countrySettings[countryCode2].documentRequired == "per_province" && countrySettings[countryCode2].documentRequiredProvinces.includes(provinceCode2))) {
        return true;
      }
    };
    ...
    (0, import_react15.useEffect)(() => {
      const handleLogData = () => __async(this, null, function* () {
        setAttribute({
    ...
    return documentRequired(countryCode, provinceCode) && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      TextField2,
      {
